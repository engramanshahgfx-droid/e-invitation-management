...
const EventTableMobileCard = ({
  ...
  const attendanceRate = event.invitationsSent > 0 ? Math.round((event.checkedIn / event.invitationsSent) * 100) : 0
      ...
      <div className="p-4">
        ...
        <div className="mb-3 grid grid-cols-3 gap-4">
          <div className="text-center">
            <p className="mb-1 text-xs text-text-secondary">Guests</p>
            <p className="font-mono text-lg font-semibold text-text-primary">{event.guestCount}</p>
          </div>
          <div className="text-center">
            <p className="mb-1 text-xs text-text-secondary">Sent</p>
            <p className="font-mono text-lg font-semibold text-text-primary">{event.invitationsSent}</p>
          </div>
          <div className="text-center">
            <p className="mb-1 text-xs text-text-secondary">Checked In</p>
            <p className="font-mono text-lg font-semibold text-text-primary">{event.checkedIn}</p>
          </div>
        </div>
        ...
        {isExpanded && (
          <div className="animate-slide-up space-y-3 border-t border-border pt-3">
            <div className="grid grid-cols-3 gap-4">
              <div className="text-center">
                <p className="mb-1 text-xs text-text-secondary">Confirmed</p>
                <p className="font-mono text-base font-semibold text-success">{event.confirmed}</p>
              </div>
              <div className="text-center">
                <p className="mb-1 text-xs text-text-secondary">Declined</p>
                <p className="font-mono text-base font-semibold text-destructive">{event.declined}</p>
              </div>
              <div className="text-center">
                <p className="mb-1 text-xs text-text-secondary">No Response</p>
                <p className="font-mono text-base font-semibold text-warning">{event.noResponse}</p>
              </div>
            </div>
            <div className="rounded-md bg-muted p-3 text-center">
              <p className="mb-1 text-xs text-text-secondary">Attendance Rate</p>
