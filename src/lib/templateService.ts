...
export const defaultTemplate: TemplateData = {
  ...
  titleAr: 'أنت مدعو!',
  message: 'We are delighted to invite you to celebrate this special occasion with us. Your presence would mean the world to us.',
...
export const templateService = {
   ...
   */
  async saveTemplate(eventId: string, template: TemplateData): Promise<{ success: boolean; error?: string; data?: SavedTemplate }> {
